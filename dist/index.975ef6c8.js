...
const onSearch = (0, _lodashDebounceDefault.default)(()=>{
    const searchValue = searchBox.value.trim();
    if (searchValue) (0, _fetchCountriesJs.fetchCountries)(searchValue).then((countries)=>{
        if (countries.length === 0) {
            (0, _notiflixDefault.default).Notify.failure("Oops, there is no country with that name");
            countryList.innerHTML = "";
            countryInfo.innerHTML = "";
        } else if (countries.length > 10) {
            (0, _notiflixDefault.default).Notify.warning("Too many matches found. Please enter a more specific name.");
            countryList.innerHTML = "";
            countryInfo.innerHTML = "";
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","./fetchCountries.js":"fTQqv","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash.debounce":"3JP5n"}],"gkKU3":[function(require,module,exports) {
